...
$7zFilePath = Join-Path $outputDir "DeveHangmanBot.7z"
$zipFilePath = Join-Path $outputDir "DeveHangmanBot.zip"

DeleteFileIfExists $7zFilePath
DeleteFileIfExists $zipFilePath
DeleteFolderIfExists $outputDir

$buildPath = Join-Path $solutionRoot "DeveHangmanBot\bin\Release\netstandard2.0"
